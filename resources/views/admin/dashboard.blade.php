...
<div class="space-y-8 max-w-6xl mx-auto">
    ...
    <div class="card">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a href="{{ route('admin.users') }}" class="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 transition-all duration-200">
                <div class="w-12 h-12 rounded-xl bg-blue-500 flex items-center justify-center shadow-lg shadow-blue-500/30">
            ...
            <a href="{{ route('education') }}" class="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-br from-primary-50 to-pink-50 hover:from-primary-100 hover:to-pink-100 transition-all duration-200">
                <div class="w-12 h-12 rounded-xl gradient-primary flex items-center justify-center shadow-lg shadow-primary-500/30">
