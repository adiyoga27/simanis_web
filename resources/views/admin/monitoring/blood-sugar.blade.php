    ...
    <div class="glass-card rounded-3xl p-6 sm:p-8 bg-mesh-rose">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                <a href="{{ route('admin.monitoring.blood-sugar.export', request()->only(['search','desa_id'])) }}" class="inline-flex items-center justify-center gap-2 text-sm font-semibold text-gray-700 rounded-2xl px-5 py-3.5 bg-white border border-gray-200 shadow-sm hover:bg-gray-50 transition-colors">
