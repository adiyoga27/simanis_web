...
@section('title', 'Detail TNT')
@section('page-title', 'Detail Terapi Nutrisi')
...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="flex items-center justify-between">
        <p class="text-sm text-gray-400">
            Disimpan pada <strong class="text-gray-600">{{ \Carbon\Carbon::parse($calculation->created_at)->isoFormat('D MMMM Y, HH:mm') }} WIB</strong>
        </p>
        <div class="flex items-center gap-3">
            <a href="{{ route('tnt.history') }}" class="btn-white text-sm inline-flex items-center gap-1.5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="p-4 space-y-3">
                    @if (!empty($time->food) && $time->food->count() > 0)
                        @foreach ($time->food as $food)
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
        <a href="{{ route('tnt.history') }}" class="btn-white w-full sm:w-auto text-center">
